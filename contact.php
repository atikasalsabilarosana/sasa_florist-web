...
<head>
  ...
  <title>Sasa Florist Website</title>
    ...
    <section id="contact" class="contact">
      <div class="container">
        ...
        <div class="section-title" data-aos="zoom-in">
          ...
          <p>Check the location of the store contact on the map below</p>
        </div>

        <div>
          <iframe style="border:0; width: 100%; height: 270px;" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d5751.947034332837!2d112.60579982450885!3d-7.951920394822135!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e78815e45bbc56d%3A0x5031ab2d7d36dba6!2sUniversitas%20Islam%20Negeri%20Maulana%20Malik%20Ibrahim%20Malang!5e0!3m2!1sid!2sid!4v1654931222330!5m2!1sid!2sid" frameborder="0" allowfullscreen></iframe>
        </div>
        <div class="row mt-5">
          ...
          <div class="col-lg-4" data-aos="fade-right">
            <div class="info">
              <div class="address">
                ...
                <h4>Location:</h4>
                <p>Gajayana Street No.50, Dinoyo, Lowokwaru, Malang, East Java</p>
              </div>

              <div class="email">
                <i class="bi bi-envelope"></i>
                <h4>Email:</h4>
                <p>sasaflorist@gmail.com</p>
              </div>
          ...
          <div class="col-lg-8 mt-5 mt-lg-0" data-aos="fade-left">
            ...
            <form action="contact_action.php" method="POST" role="form">
              ...
              <div class="text-center"><input type="submit" class="btn btn-dark text-white" name="bantuan" value="Send Message"></div>
            </form>
