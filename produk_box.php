  ...
  <header id="header" class="d-flex align-items-center">
	...
	<div class="container-fluid p-5">
		...
		<div class="row" >
			<?php
				include 'koneksi.php';
				$query_box = "SELECT * FROM jenisbox";
				$result_box = $koneksi->query($query_box);
				while($row_box = mysqli_fetch_array($result_box)){ ?>
					<div class="col">
						<div class="card shadow border-0 mb-5">
							<img src="<?php echo $row_box['gambar']?>" class="card-img-top" height="400" width="400" >
							<div class="card-body">
								<h5 class="card-title"><?php echo $row_box['nama_barang']?></h5>
								<p class="card-text"><?php echo $row_box['keterangan']?></p>
								<h5 class="card-title"><?php echo $row_box['harga']?></h5>
								<a href="transaksi_box.php?beli=<?php echo $row_box['id_barang_box']; ?>" class="btn btn-primary px-4 shadow">Beli</a>
