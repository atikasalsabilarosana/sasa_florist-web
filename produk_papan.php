  ...
  <header id="header" class="d-flex align-items-center">
	...
	<div class="container-fluid p-5">
		...
		<div class="row" >
			<?php
				include 'koneksi.php';
				$query_papan = "SELECT * FROM jenispapan";
				$result_papan = $koneksi->query($query_papan);
				while($row_papan = mysqli_fetch_array($result_papan)){ ?>
					<div class="col">
						<div class="card shadow border-0 mb-5">
							<img src="<?php echo $row_papan['gambar']?>" class="card-img-top" height="400" width="400" >
							<div class="card-body">
								<h5 class="card-title"><?php echo $row_papan['nama_barang']?></h5>
								<p class="card-text"><?php echo $row_papan['keterangan']?></p>
								<h5 class="card-title"><?php echo $row_papan['harga']?></h5>
								<a href="transaksi_box.php?beli=<?php echo $row_papan['id_barang_papan']; ?>" class="btn btn-primary px-4 shadow">Beli</a>
							</div>
						</div>	
					</div>
					<?php
