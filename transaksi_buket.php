...
<head>
	...
	<title>Detail Transaksi Buket</title>
...
<body style = "background-image: url(assets/img/background2.jpg);>
	<div class="container-fluid d-flex justify-content-center align-items-center">
		<div class="container shadow p-4">
			<form action="transaksi_buket.php" method="POST">
			<?php
				include 'koneksi.php';
				$harga = 0;
				$id_buket = 0;
				if(isset($_GET['beli'])){
					$id_buket = $_GET['beli'];
					$query_trans = "SELECT * FROM jenisbuket WHERE id_barang_buket='".$id_buket."'";
			...
			<h2 class="mb-3">Detail Transaksi</h2>
			 ...
			 <div class="form-group mb-3">
			    ...
			    <input type="text" class="form-control mt-2" id="nama_barang" name="id_barang" value="<?php echo $id_buket ?>">
			 </div>
			   <div class="form-group mb-3">
		...
		<?php
			if(isset($_POST['beli'])){
				...
				$id_buket = $_POST['id_barang'];
				$jumlah_barang = $_POST['jumlah_barang'];
				$harga = $_POST['harga_barang'];
				$total = $_POST['total_harga'];
				$alamat = $_POST['alamat'];
				$query_insert = "INSERT INTO transaksi(id_member, id_barang_buket, jumlah_barang, total_harga, alamat) VALUES('".$id_member."', '".$id_buket."', '".$jumlah_barang."', '".$total."', '".$alamat."')";
