	...
	<div class="container-fluid d-flex justify-content-center align-items-center">
		<div class="container shadow p-4">
			...
			<?php
				...
				if(isset($_GET['beli'])){
					$id_box = $_GET['beli'];
					$query_trans = "SELECT * FROM jenispapan WHERE id_barang_papan='".$id_papan."'";
			...
			<h2 class="mb-3">Detail Transaksi</h2>
			 ...
			 <div class="form-group mb-3">
			    ...
			    <input type="text" class="form-control mt-2" id="nama_barang" name="id_barang" value="<?php echo $id_papan ?>">
			 </div>
			   <div class="form-group mb-3">
		...
		<?php
			if(isset($_POST['beli'])){
				...
				$id_papan = $_POST['id_barang'];
				$jumlah_barang = $_POST['jumlah_barang'];
				$harga = $_POST['harga_barang'];
				$total = $_POST['total_harga'];
				$alamat = $_POST['alamat'];
				$query_insert = "INSERT INTO transaksi(id_member, id_barang_papan, jumlah_barang, total_harga, alamat) VALUES('".$id_member."', '".$id_papan."', '".$jumlah_barang."', '".$total."', '".$alamat."')";
